...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/inventory/steel_work_number.css') }}" />
@endsection
                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->work}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input id="work"></div>
                            ...
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-label"><label>TPM JOB</label></div>
                                    <div class="grid-input"><input id="tpm_job" type="checkbox"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/inventory/steel_work_number.js') }}"></script>
    <script>
