...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/inventory/used_mesh.css') }}" />
@endsection
                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->mesh_no}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input id="no_of_mesh"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/inventory/used_mesh.js') }}"></script>
    <script>
