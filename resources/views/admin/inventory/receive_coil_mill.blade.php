...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/inventory/receive_coil_mill.css') }}" />
@endsection
                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->coil_no}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input id="coil_no"></div>
                                    <div class="grid-label"><label>Number of coils</label></div>
                                    <div class="grid-input"><input type="number" id="no_of_coil"></div>
                                    <div class="grid-label"><label>Weight</label></div>
                                    <div class="grid-input"><input type="number" id="weight"></div>
                                    ...
                                    <div class="grid-input"><input id="cycles"></div>
                                    <div class="grid-label"><label>Footage</label></div>
                                    <div class="grid-input"><input type="number" id="footage"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input type="date" id="date_received"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/inventory/receive_coil_mill.js') }}"></script>
    <script>
