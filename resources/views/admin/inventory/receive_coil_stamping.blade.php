...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/inventory/receive_coil_stamping.css') }}" />
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/inventory/receive_coil_stamping.js') }}"></script>
    <script>
