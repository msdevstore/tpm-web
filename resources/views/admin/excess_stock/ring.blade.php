...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/excess_stock/ring.css') }}" />
@endsection
                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input type="number" id="ring"></div>
                                    <div class="grid-label"><label>Excess Stock Quantity</label></div>
                                    <div class="grid-input"><input type="number" id="excess_qty"></div>
                                    <div class="grid-label"><label>Date Produced</label></div>
                                    <div class="grid-input"><input type="date" id="date_produced"></div>
                                    <div class="grid-label"><label>Location Of Storage</label></div>
                                    <div class="grid-input"><input id="los"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/excess_stock/ring.js') }}"></script>
    <script>
