                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input id="ID"></div>
                                    <div class="grid-label"><label>Name</label></div>
                                    <div class="grid-input"><input id="name"></div>
                                    <div class="grid-label"><label>Mill Operator</label></div>
                                    <div class="grid-input"><input id="mill_operator" type="checkbox"></div>
                                    <div class="grid-label"><label>Cut-off Operator</label></div>
                                    <div class="grid-input"><input id="cutoff_operator" type="checkbox"></div>
                                    <div class="grid-label"><label>Repair Operator</label></div>
                                    <div class="grid-input"><input id="repair_welder" type="checkbox"></div>
                                    <div class="grid-label"><label>Inspector</label></div>
                                    <div class="grid-input"><input id="inspector" type="checkbox"></div>
                                    <div class="grid-label"><label>General Laborer</label></div>
                                    <div class="grid-input"><input id="general_laborer" type="checkbox"></div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/employee.js') }}"></script>
    <script>
