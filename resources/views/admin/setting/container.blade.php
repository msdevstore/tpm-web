                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    <div class="grid-label"><label>Container ID</label></div>
                                    <div class="grid-input"><input type="number" id="cont_type"></div>
                                    <div class="grid-label"><label>Container Type</label></div>
                                    <div class="grid-input"><input id="cont_type"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/container.js') }}"></script>
    <script>
