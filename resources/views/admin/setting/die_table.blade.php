                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->die}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    <div class="grid-label"><label>Die Number</label></div>
                                    <div class="grid-input"><input id="die" type="number"></div>
                                    <div class="grid-label"><label>Die ID</label></div>
                                    <div class="grid-input"><input id="die_id" type="number"></div>
                                    <div class="grid-label"><label>Notes</label></div>
                                    <div class="grid-input"><textarea id="notes"></textarea></div>
                                    <div class="grid-label"><label>Clamp od</label></div>
                                    <div class="grid-input"><input id="clamp_od" type="number"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/die_table.js') }}"></script>
    <script>
