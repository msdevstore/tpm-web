                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    <div class="grid-label"><label>Ship ID</label></div>
                                    <div class="grid-input"><input type="number" id="ID"></div>
                                    <div class="grid-label"><label>Ship Type</label></div>
                                    <div class="grid-input"><input id="ship_method"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/ship_method.js') }}"></script>
    <script>
