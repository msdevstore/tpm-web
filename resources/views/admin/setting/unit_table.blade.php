                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->unit_id}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    <div class="grid-label"><label>Unit ID</label></div>
                                    <div class="grid-input"><input id="unit_id"></div>
                                    <div class="grid-label"><label>Units</label></div>
                                    <div class="grid-input"><input id="units"></div>
                                    <div class="grid-label"><label>Measurement</label></div>
                                    <div class="grid-input"><input id="measure"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/unit_table.js') }}"></script>
    <script>
