                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    <div class="grid-label"><label>TPM ID</label></div>
                                    <div class="grid-input"><input id="ID" type="number"></div>
                                    <div class="grid-label"><label>TPM Type</label></div>
                                    <div class="grid-input"><input id="TPM_Type"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/tpm_type.js') }}"></script>
    <script>
