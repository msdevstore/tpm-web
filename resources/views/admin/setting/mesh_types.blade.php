                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->mesh_id}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    ...
                                    <div class="grid-input"><input id="mesh_id"></div>
                                    <div class="grid-label"><label>Mesh</label></div>
                                    <div class="grid-input"><input id="mesh"></div>
                                    <div class="grid-label"><label>Wires</label></div>
                                    <div class="grid-input"><input id="wires"></div>
                                    <div class="grid-label"><label>Weave</label></div>
                                    <div class="grid-input"><input id="weave"></div>
                                    <div class="grid-label"><label>Thickness</label></div>
                                    <div class="grid-input"><input id="thickness"></div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/mesh_types.js') }}"></script>
    <script>
