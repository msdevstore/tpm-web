                ...
                <div class="card-body">
                    ...
                    <table class="table table-separate table-hover table-head-custom table-foot-custom table-checkable kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach($obj_arr as $obj)
                            <tr class="main-table-btn" data="{{$obj->decimal}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="grid-container-3 mb-5">
                                    ...
                                    <div class="grid-input"><input id="decimal"></div>
                                </div>
                                <div class="d-flex">
                                ...
                                <div class="pt-5">
                                    <button class="btn-control mb-2">Fraction To Decimal</button>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/fraction_table.js') }}"></script>
    <script>
