                        ...
                        <div class="row">
                            <div class="col-lg-6 gutter-b">
                                <div class="grid-container-3">
                                    <div class="grid-label"><label>Status ID</label></div>
                                    <div class="grid-input"><input type="number" id="ID"></div>
                                    <div class="grid-label"><label>Status Type</label></div>
                                    <div class="grid-input"><input id="status"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/setting/status_type.js') }}"></script>
    <script>
