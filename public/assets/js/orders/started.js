        ...
        success: function(res) {
            ...
            if (res.length > 0) {
                if (type === "1") {
                    tbodyContent = '<tr>';
                    res.forEach((obj, index) => {
                        tbodyContent += `<td>${obj.hasOwnProperty('mesh') ? obj['mesh'] : ''}</td>
                    ...
                    tbodyContent = '<tr>';
                    res.forEach(obj => {
                        tbodyContent += `<td><input type="checkbox" name="mesh_data_select" value="${obj.hasOwnProperty('mesh_no') ? obj['mesh_no'] : ''}" />
                            ${obj.hasOwnProperty('mesh') ? obj['mesh'] : ''}</td>
                            <td>${obj.hasOwnProperty('type') ? obj['type'] : ''}</td>
                            <td>${obj.hasOwnProperty('date_received') ? obj['date_received'] : ''}</td>
                            <td>${obj.hasOwnProperty('width') ? obj['width'] : ''}</td>
                            <td>${obj.hasOwnProperty('length') ? obj['length'] : ''}</td>
